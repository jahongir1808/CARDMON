    ...
    <div className="cardmon-layout vh-100 bg-light m-auto">
        ...
        {active === 1 ? (
          <Form onSubmit={addExpense}>
            <Modal.Header closeButton>
              <Modal.Title>Операции</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              ...
              <Form.Group className="mb-3">
                <Form.Label>Дата и время операции</Form.Label>
          ...
          <Form onSubmit={addDebts}>
            ...
            <Modal.Body>
              ...
              <Form.Group className="mb-3">
                <Form.Label>Имя должника</Form.Label>
                <InputGroup className="mb-3">
                  <Form.Control
                    onChange={handleDebtsChange}
                    name="debtsName"
              ...
              <Form.Group className="mb-3">
                <Form.Label>Оставьте заметку</Form.Label>
                <Form.Control
                  onChange={handleDebtsChange}
                  name="description"
                  placeholder="Заметка"
              ...
              <Form.Group className="mb-3">
                <Form.Label>Выберите cрок оплаты</Form.Label>
                <div className="d-flex justify-content-between">
                  <Form.Control
                    onChange={handleDebtsChange}
                    name="dueDate"
      ...
      {active === 1 ? (
        <Modal show={confirmShow} onHide={handleConfirmClose}>
          <Modal.Header closeButton>
            <Modal.Title>Вы хотите удалить ?</Modal.Title>
          </Modal.Header>
          <Modal.Footer>
